---
title: "Have Our Cities Become Financial Products?"
...
In 2024, more than **115,000 m² of office space** were marketed in the metropolis, placing Montpellier among the most active regional tertiary markets ([BNP Paribas Real Estate](https://www.bnppre.fr/actualites/marche-immobilier/marche-immobilier-des-bureaux-en-regions-en-2024-montpellier-dans-le-top-5.html)). Districts like **Cambacérès**, around the Sud de France station, concentrate emblematic projects combining offices, shops, and services ([La Tribune](https://objectif-languedoc-roussillon.latribune.fr/entreprises/immobilier/2024-09-09/a-montpellier-le-marche-d-immobilier-de-bureaux-sauve-les-meubles-1006005.html)).
...
- but the production of new housing is in freefall: **about 2,100 homes built in 2023**, far from the initial targets of more than 5,000 per year ([Le Point](https://www.lepoint.fr/societe/montpellier-une-metropole-sous-pression-21-10-2024-2573215_23.php)).
...
- local developers like **FDI Promotion** or **M&A Promotion**, very present in the territory ([FDI](https://www.fdi.fr/le-groupe/fdi-promotion));
- national groups linked to major construction and real estate players, like **Sogeprom / Vinci Immobilier** ([Vinci Immobilier](https://www.vinci-immobilier-institutionnel.com)).
...
Nationally, this logic is widely documented. As *Le Monde* points out, the financialization of real estate leads to producing surfaces (especially offices) **disconnected from real social needs**, while allowing the housing crisis to persist ([Le Monde](https://www.lemonde.fr/idees/article/2025/09/03/en-misant-sur-la-reconversion-des-bureaux-vides-l-etat-donne-l-illusion-d-agir-sur-la-crise-du-logement_6638515_3232.html)).
...
The **Real Solidarity Lease (Bail Réel Solidaire - BRS)** allows separating the ownership of the land from that of the housing. The land is held by a non-profit **Land Solidarity Organization (OFS)**, which prevents speculation and keeps housing affordable over time ([BRS – Wikipédia](https://fr.wikipedia.org/wiki/Bail_r%C3%A9el_solidaire)).

Montpellier Méditerranée Métropole has established a **local OFS**, associating public actors and social landlords ([Montpellier.fr](https://www.montpellier.fr/actions/competences/acces-au-logement/lorganisme-foncier-solidaire)).
...
that of the **commons**, resources managed collectively by the users themselves ([OpenEdition](https://journals.openedition.org/regulation/10452)).

Applied to housing, this results in:
- **Community Land Trusts** (CLT), where land is held in trust for a community ([Community Land Trust](https://fr.wikipedia.org/wiki/Community_Land_Trust));
- **residents' cooperatives** or participatory housing, where the goal is to live together rather than maximize market value ([Habitat participatif](https://fr.wikipedia.org/wiki/Cohabitat)).
