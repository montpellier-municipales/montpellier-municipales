---
title: "Nos villes sont-elles devenues des produits financiers ?"
...
En 2024, plus de **115 000 m² de bureaux** ont été commercialisés sur la métropole, plaçant Montpellier parmi les marchés tertiaires régionaux les plus actifs ([BNP Paribas Real Estate](https://www.bnppre.fr/actualites/marche-immobilier/marche-immobilier-des-bureaux-en-regions-en-2024-montpellier-dans-le-top-5.html)). Des quartiers comme **Cambacérès**, autour de la gare Sud de France, concentrent des projets emblématiques mêlant bureaux, commerces et services ([La Tribune](https://objectif-languedoc-roussillon.latribune.fr/entreprises/immobilier/2024-09-09/a-montpellier-le-marche-d-immobilier-de-bureaux-sauve-les-meubles-1006005.html)).
...
- mais la production de logements neufs est en chute libre : **environ 2 100 logements construits en 2023**, loin des objectifs initiaux de plus de 5 000 par an ([Le Point](https://www.lepoint.fr/societe/montpellier-une-metropole-sous-pression-21-10-2024-2573215_23.php)).
...
- des promoteurs locaux comme **FDI Promotion** ou **M&A Promotion**, très présents sur le territoire ([FDI](https://www.fdi.fr/le-groupe/fdi-promotion)) ;
- des groupes nationaux liés aux grands acteurs du BTP et de l’immobilier, comme **Sogeprom / Vinci Immobilier** ([Vinci Immobilier](https://www.vinci-immobilier-institutionnel.com)).
...
À l’échelle nationale, cette logique est largement documentée. Comme le souligne *Le Monde*, la financiarisation de l’immobilier conduit à produire des surfaces (notamment de bureaux) **déconnectées des besoins sociaux réels**, tout en laissant perdurer la crise du logement ([Le Monde](https://www.lemonde.fr/idees/article/2025/09/03/en-misant-sur-la-reconversion-des-bureaux-vides-l-etat-donne-l-illusion-d-agir-sur-la-crise-du-logement_6638515_3232.html)).
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/l3IyxFUBCbw?si=CTOtCZz72qC5e-QP" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
...
Le **Bail Réel Solidaire (BRS)** permet de séparer la propriété du terrain de celle du logement. Le foncier est détenu par un **Organisme de Foncier Solidaire (OFS)** à but non lucratif, ce qui empêche la spéculation et maintient les logements abordables dans le temps ([BRS – Wikipédia](https://fr.wikipedia.org/wiki/Bail_r%C3%A9el_solidaire)).

Montpellier Métropole s’est dotée d’un **OFS local**, associant acteurs publics et bailleurs sociaux ([Montpellier.fr](https://www.montpellier.fr/actions/competences/acces-au-logement/lorganisme-foncier-solidaire)).
...
celle des **communs**, des ressources gérées collectivement par les usagers eux-mêmes ([OpenEdition](https://journals.openedition.org/regulation/10452)).

Appliqué au logement, cela donne :
- des **Community Land Trusts** (CLT), où le foncier est mis en fiducie au service d’une communauté ([Community Land Trust](https://fr.wikipedia.org/wiki/Community_Land_Trust)) ;
- des **coopératives d’habitants** ou de l’habitat participatif, où l’objectif est d’habiter ensemble plutôt que de maximiser une valeur marchande ([Habitat participatif](https://fr.wikipedia.org/wiki/Cohabitat)).
