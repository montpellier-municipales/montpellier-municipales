...
import budgetData from "~/content/data/ville_budget_2022.json";
...
import apcpData from "~/content/data/ville_apcp_2022.json";
import type { PersonnelLine, AssetLine, LoanLine } from "~/types/ville";
import type { BudgetData } from "~/types/budget";
import type { ApcpData } from "~/types/apcp";

export default component$(() => {
  const currentPersonnel = (personnelData as any)["2022"] as PersonnelLine[] || [];
  const currentPatrimoine = (patrimoineData as any)["2022"] as AssetLine[] || [];
  const currentLoans = (loanData as any)["2022"] as LoanLine[] || [];
...
export const head: DocumentHead = () => {
  ...
  return {
    title: t("budget.ville.title", { year: "2022" }),
    meta: [
      {
        name: "description",
        content: t("budget.ville.metaDescription", { year: "2022" }),
      },
    ],
  };
};
