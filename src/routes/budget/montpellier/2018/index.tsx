...
import budgetData from "~/content/data/ville_budget_2018.json";
...
export default component$(() => {
  const currentPersonnel =
    ((personnelData as any)["2018"] as PersonnelLine[]) || [];
  const currentPatrimoine =
    ((patrimoineData as any)["2018"] as AssetLine[]) || [];
  const currentLoans = ((loanData as any)["2018"] as LoanLine[]) || [];
...
export const head: DocumentHead = () => {
  ...
  return {
    title: t("budget.ville.title", { year: "2018" }),
    meta: [
      {
        name: "description",
        content: t("budget.ville.metaDescription", { year: "2018" }),
      },
    ],
  };
};
